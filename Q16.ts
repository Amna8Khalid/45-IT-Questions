...
// const myfriends: string [] = ["Ayesha", "Romaisa", "Abeer", "Maha", "Haniya","Sara"];

// console.log(`Table is not availible I can invite only 2 persons\n`)
...
//     console.log(`miss.${myfriends[i]} you are still invited to my house for dinner`)
// }
